...
<body ng-init="pageTitle='报告管理';">
<div class="container-full" ng-controller="reportController">
    ...
    <div class="edit-body row" style="overflow: hidden">
        ...
        <div class="col-md-12" style="padding: 0px; text-align: right;">
        	<div class="form-group">
                <div class="col-md-4">
                    <label class="col-md-4">报告名称：</label>
                    <div class="col-md-8">
                        <div class="searchContent">
                            <input class="searchInput" type="text" ng-model="report.name"
                                   placeholder="输入报告名称,按回车键搜索" style="float: left;text-indent: 10px;width: 250px;"/>
                ...
                <div class="col-md-4">
                    ...
                    <div class="col-md-8"> 
                     	<div class="searchContent">
	                        <div date-picker divid='createtime' ng-model="report.createtime" ng-type="year"
                ...
                <div class="col-md-4">
                    <label class="col-md-4">报告类别：</label>
                    <div class="col-md-8">
...
<script type="text/javascript" src="<common:webRoot/>/resources/epsm/decisionsupport/reportmanager/report.js?v=${sysversion}"></script>
</body>
