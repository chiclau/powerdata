...
<body ng-init="pageTitle='报告详情';operationType='${operationType }';report.ID='${ID}';">
<div class="container-fluid" ng-controller="reportDetailController">
	<div class="row">
        <div class="edit-header">
            <div class="col-xs-4 edit-title" style="padding-left: 0"><i class="icon"></i>报告详情</div>
        ...
        <div class="edit-body" style="margin-left: -100px">
            <form id="myVaildate" class="form-horizontal class-for-readonly" name="validateForm">
                <div class="form-group">
                    <div class="col-md-6">
                        <label class="col-md-4 control-label oneline"><i class="pd-required">*</i>报告名称：</label>
                        <div class="col-md-8">
                        	<input ng-readonly="isRead" ng-model="report.J_NAME" type="text" class="form-control easyui-validatebox"
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="col-md-8">
	                        <div date-picker divid='createtime' ng-model="report.J_CREATE_TIME"  ng-config="createtime"
                ...
                <div class="form-group">
                    <div class="col-md-6">
                        <label class="col-md-4 control-label oneline">报告类别：</label>
                        <div class="col-md-8">
...
<script type="text/javascript" src="<common:webRoot />/resources/epsm/decisionsupport/reportmanager/reportdetail.js?v=${sysversion}"></script>
