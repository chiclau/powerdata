...
<body ng-init="pageTitle='企业用户信息管理';currUserId='${SESSION_USER.yhid}';companyUser.QYID='${SESSION_USER_EXTEND.qyid}';">
<div class="container-full" ng-controller="companyUserManageController">
...
<script type="text/javascript" src="<common:webRoot/>/resources/epsm/dataacquisition/companyuser/companyusermanage.js?v=${sysversion}"></script>
</body>
