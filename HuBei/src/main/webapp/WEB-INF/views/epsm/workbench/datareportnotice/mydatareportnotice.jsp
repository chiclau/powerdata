	...
	<div class="container-full" ng-controller="dataReportNoticeListController">
		<div class="edit-header row" style="overflow: hidden">
			...
			<div class="col-xs-8 edit-btn-box">
				<button type="button" class="btn btn-default btn-sm" ng-click="toSearchData()">查&nbsp;询</button>
			</div>
		</div>
...
<script type="text/javascript" src="<common:webRoot />/resources/epsm/workbench/datareportnotice/mydatareportnotice.js?v=${sysversion}"></script>
</body>
