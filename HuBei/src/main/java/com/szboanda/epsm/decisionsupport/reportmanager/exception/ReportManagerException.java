...
package com.szboanda.epsm.decisionsupport.reportmanager.exception;

import com.szboanda.platform.common.base.BaseException;

/**
 * @title:      报告管理 
 * @fileName:   ReportManagerException.java
 ...
 * @version:    V1.0
 */
public class ReportManagerException extends BaseException {
    /**
     * 序列化号
     */
     ...
     * @param message
     */
    public ReportManagerException(Exception ex) {
        super(ex);
    }
     ...
     * @param cause
     */
    public ReportManagerException(String message, String code) {
        super(message, code);
    }
